...
export default function Navigation({ onStartLearning, onPricingClick, onFaqsClick, onFeaturesClick }: NavigationProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2">
            <div className="relative h-8 w-12 sm:h-10 sm:w-16">
            ...
            <h1 className={`${robotoMono.className} text-xl font-medium text-black tracking-wider`}>Polymath</h1>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            <button
              ...
              className={`${robotoMono.className} text-gray-700 hover:text-black transition-colors duration-200 font-medium`}
            >
              Features
            </button>
            <button
            ...
            <Button
              ...
              className="bg-black text-white hover:bg-gray-800 transition-all duration-300 transform hover:scale-105 px-6 py-2 text-sm font-medium rounded-lg shadow-md hover:shadow-lg"
            >
              Start Learning
            </Button>
          </div>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t border-gray-200">
              <button
                ...
                className={`${robotoMono.className} block w-full text-left px-3 py-2 text-gray-700 hover:text-black hover:bg-gray-50 transition-colors duration-200 font-medium rounded-md`}
              >
                Features
              </button>
              <button
              ...
              <div className="pt-2">
                <Button
                  ...
                  className="w-full bg-black text-white hover:bg-gray-800 transition-all duration-300 px-6 py-2 text-sm font-medium rounded-lg shadow-md hover:shadow-lg"
                >
                  Start Learning
                </Button>
              </div>
